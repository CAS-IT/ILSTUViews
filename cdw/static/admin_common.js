...
$(function(){var $body=$('body');if(klasses.join){if($body.is('.'+klasses.join(',.'))){fn();}}else{if($body.hasClass(klasses)){fn();}}});};$(function(){$('form.delete-form button[type=submit]').click(function(e){if(confirm("All data (including responses) associate with this question will be permanently deleted.  Do you want to continue?")){return true}
